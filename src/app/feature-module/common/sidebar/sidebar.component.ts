...
export class SidebarComponent {
  ...
  multiLevel2 = false;
  multiLevel3 = false;
  schoolName: string=localStorage.getItem("schoolName") || 'Malagiree English Boarding School';
  schoolLogo: string=localStorage.getItem("schoolLogo") || "assets/img/school_logo.png";
